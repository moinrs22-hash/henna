 ...
 * Contact: +91 8097053485 | Location: Mumbai
...
function openLightbox(item) {
  ...
  if (inquireBtn) {
    ...
    inquireBtn.href = `Https://WA.me/918097053485?text=${text}`;
  }
...
Please let me know if this date is available. Looking forward to your reply!`;
    ...
    if (whatsappSubmitBtn) {
      whatsappSubmitBtn.href = `Https://WA.me/918097053485?text=${encodeURIComponent(message)}`;
    }
  }
